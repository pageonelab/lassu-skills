...
1. Discover `lassu_draw_get_context`. Check the connected account, workspace, board quota and capabilities. If the remote connection is missing, read [connection](references/connection.md). Do not require desktop installation for drawing.
